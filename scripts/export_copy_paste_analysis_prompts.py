#!/usr/bin/env python3
"""Export copy/paste analysis prompts as copy/paste YAML files."""
...
OUT_DIR = REPO_ROOT / "docs" / "copy-paste-analysis-prompts"
...
def _export_payload(template: Dict[str, Any], source_path: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "generation_source": {
            "generated_by": "scripts/export_copy_paste_analysis_prompts.py",
...
def main() -> int:
    ...
    index_lines = [
        ...
        "",
        "```bash",
        "python3 scripts/export_copy_paste_analysis_prompts.py",
        "```",
        "",
        "## Files",
        "",
    ...
    print(f"Exported {len(written)} copy/paste analysis prompt YAML files to {OUT_DIR}")
    return 0
