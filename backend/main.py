...
from .jobs.prepass import (
    _manifest_count,
    _tail_text,
    _sanitize_ticker_for_dir,
    _flatten_prepass_bundle_milestone,
    _build_stage1_prepass_source_rows_from_bundle,
    _run_subprocess_capture,
    _run_authoritative_prepass_bundle_subprocess,
    _prepare_stage1_authoritative_prepass_bundle,
)
from .routers.conversations import (
    build_enhanced_context,
    build_template_context_for_prompt,
    normalize_council_mode,
...
# research_service singleton lives in backend/jobs/state.py (imported by conversations router).
