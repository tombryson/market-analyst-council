...
SCENARIO_ROUTER_MODEL_ADJUDICATION_ENABLED = _get_bool(
    "SCENARIO_ROUTER_MODEL_ADJUDICATION_ENABLED",
    default=True,
)
SCENARIO_ROUTER_MODEL_ADJUDICATION_MODEL = os.getenv(
    "SCENARIO_ROUTER_MODEL_ADJUDICATION_MODEL",
    "google/gemini-3.1-flash-lite",
).strip()
SCENARIO_ROUTER_MODEL_ADJUDICATION_TIMEOUT_SECONDS = _get_float(
    "SCENARIO_ROUTER_MODEL_ADJUDICATION_TIMEOUT_SECONDS",
    45.0,
)
SCENARIO_ROUTER_MODEL_ADJUDICATION_MAX_OUTPUT_TOKENS = _get_int(
    "SCENARIO_ROUTER_MODEL_ADJUDICATION_MAX_OUTPUT_TOKENS",
    900,
)
SCENARIO_ROUTER_MODEL_ADJUDICATION_MAX_CASES = _get_int(
    "SCENARIO_ROUTER_MODEL_ADJUDICATION_MAX_CASES",
    3,
)
SCENARIO_ROUTER_MODEL_ADJUDICATION_REASONING_EFFORT = os.getenv(
    "SCENARIO_ROUTER_MODEL_ADJUDICATION_REASONING_EFFORT",
    "",
).strip().lower()
SCENARIO_ROUTER_THESIS_JUDGE_ENABLED = _get_bool(
    "SCENARIO_ROUTER_THESIS_JUDGE_ENABLED",
    default=True,
)
SCENARIO_ROUTER_THESIS_JUDGE_MODEL = os.getenv(
    "SCENARIO_ROUTER_THESIS_JUDGE_MODEL",
    SCENARIO_ROUTER_MODEL_ADJUDICATION_MODEL,
).strip()
SCENARIO_ROUTER_THESIS_JUDGE_TIMEOUT_SECONDS = _get_float(
    "SCENARIO_ROUTER_THESIS_JUDGE_TIMEOUT_SECONDS",
    75.0,
)
SCENARIO_ROUTER_THESIS_JUDGE_MAX_OUTPUT_TOKENS = _get_int(
    "SCENARIO_ROUTER_THESIS_JUDGE_MAX_OUTPUT_TOKENS",
    1800,
)
SCENARIO_ROUTER_THESIS_JUDGE_REASONING_EFFORT = os.getenv(
