...
PREALLOCATED_COMPANY_TYPES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "aliases": ["copper", "cu", "copper_mining"],
        "detection_keywords": [
            "copper",
            "cu",
            "concentrate",
    ...
    },
    {
        ...
        "description": "Base-metals mining, development, or exploration company where zinc, lead, nickel, tin, manganese, or mixed base metals drive value.",
        "default_template_id": "base_metals_miner",
        "template_candidates": ["base_metals_miner", "diversified_miner", "general_equity"],
        "aliases": ["base_metals", "base_metals_miner", "zinc", "lead", "nickel", "tin", "manganese"],
        "detection_keywords": [
            "base metals",
            "zinc",
            "lead",
    ...
    },
    {
        "id": "iron_ore_miner",
        "name": "Iron Ore Miner",
        "description": "Iron ore producer, developer, or explorer.",
        "default_template_id": "iron_ore_miner",
        "template_candidates": ["iron_ore_miner", "diversified_miner", "general_equity"],
        "aliases": ["iron_ore", "iron_ore_mining", "hematite", "magnetite"],
        "detection_keywords": [
            "iron ore",
            "hematite",
            "magnetite",
    ...
    {
        "id": "rare_earths_critical_minerals",
        "name": "Rare Earths/Critical Minerals",
        "description": "Rare earths or critical minerals company with mining, processing, or supply-chain exposure.",
        "default_template_id": "rare_earths_critical_minerals",
        "template_candidates": ["rare_earths_critical_minerals", "diversified_miner", "general_equity"],
        "aliases": ["rare_earths", "critical_minerals", "ndpr", "magnet_metals"],
        "detection_keywords": [
            "rare earth",
            "critical minerals",
            "ndpr",
    ...
    },
    {
        "id": "coal_miner",
        "name": "Coal Miner",
        "description": "Thermal coal or metallurgical coal producer, developer, or explorer.",
        "default_template_id": "coal_miner",
        "template_candidates": ["coal_miner", "diversified_miner", "general_equity"],
        "aliases": ["coal", "thermal_coal", "met_coal", "coking_coal"],
        "detection_keywords": [
            "coal",
            "thermal coal",
            "metallurgical coal",
    ...
    {
        "id": "asset_managers_diversified_financials",
        "name": "Asset Managers/Diversified Financials",
        "description": "Asset managers, wealth platforms, exchanges, brokers, and diversified financials.",
        "default_template_id": "asset_managers_diversified_financials",
        "template_candidates": [
            "asset_managers_diversified_financials",
            "bank_financials",
            "financials_bank_insurance",
            "general_equity",
        ],
        "aliases": ["asset_manager", "fund_manager", "wealth_manager", "broker", "exchange"],
        "detection_keywords": [
            "asset manager",
            "fund manager",
            "wealth management",
    ...
    },
    {
        "id": "utilities",
        "name": "Utilities",
        "description": "Regulated utilities, electricity, gas, water, networks, and gentailers.",
        "default_template_id": "utilities",
        "template_candidates": ["utilities", "industrials", "general_equity"],
        "aliases": ["utility", "power_utility", "water_utility", "gas_distribution", "gentailer"],
        "detection_keywords": [
            "utility",
            "utilities",
    ...
    },
    {
        ...
        "description": "Telecom carriers, mobile, fixed-line, fibre, tower, and broadband infrastructure companies.",
        "default_template_id": "telecommunications",
        "template_candidates": ["telecommunications", "technology_platforms", "general_equity"],
        "aliases": ["telecom", "telco", "mobile_network", "broadband", "fibre", "fiber"],
        "detection_keywords": [
            "telecom",
            "telecommunications",
            "mobile network",
    ...
    },
    {
        ...
        "description": "Airlines, rail, freight, ports, shipping, logistics, and supply-chain operators.",
        "default_template_id": "transport_logistics",
        "template_candidates": ["transport_logistics", "industrials", "general_equity"],
        "aliases": ["transport", "logistics", "airline", "rail", "freight", "shipping", "ports"],
        "detection_keywords": [
            "transport",
            "logistics",
            "airline",
    ...
    },
    {
        ...
        "description": "Contractors, EPC/EPCM, infrastructure builders, developers, and engineering services companies.",
        "default_template_id": "construction_engineering",
        "template_candidates": ["construction_engineering", "industrials", "general_equity"],
        "aliases": ["construction", "contractor", "epc", "epcm", "civil_engineering"],
        "detection_keywords": [
            "construction",
            "engineering",
            "contractor",
    ...
    },
    {
        ...
        "description": "Contract mining, drilling, blasting, equipment hire, mine-site services, maintenance, and mining EPCM companies.",
        "default_template_id": "mining_services",
        "template_candidates": ["mining_services", "construction_engineering", "chemicals_materials", "industrials", "general_equity"],
        "aliases": [
            "mining_services",
            "mine_services",
            "contract_mining",
    ...
    },
    {
        "id": "infrastructure",
        "name": "Infrastructure",
        "description": "Infrastructure owners, operators, developers, concession assets, and contracted essential-service platforms.",
        "default_template_id": "infrastructure",
        "template_candidates": ["infrastructure", "utilities", "transport_logistics", "construction_engineering", "industrials", "general_equity"],
        "aliases": ["infrastructure", "concession", "regulated_asset", "essential_services"],
        "detection_keywords": [
            "infrastructure",
            "concession",
            "regulated asset",
    ...
    },
    {
        ...
        "description": "Chemicals, fertilizers, explosives, industrial gases, and specialty materials companies.",
        "default_template_id": "chemicals_materials",
        "template_candidates": ["chemicals_materials", "industrials", "general_equity"],
        "aliases": ["chemicals", "materials", "fertilizer", "fertiliser", "industrial_gases"],
        "detection_keywords": [
            "chemical",
            "chemicals",
            "materials",
    ...
    {
        "id": "steel_base_metals_processing",
        "name": "Steel/Base Metals Processing",
        "description": "Steel producers, metal recyclers, downstream metal processors, and base-metals processing companies.",
        "default_template_id": "steel_base_metals_processing",
        "template_candidates": ["steel_base_metals_processing", "chemicals_materials", "industrials", "general_equity"],
        "aliases": ["steel", "steelmaker", "metal_recycling", "base_metals_processing", "smelter"],
        "detection_keywords": [
            "steel",
            "steelmaker",
            "scrap",
    ...
    {
        "id": "forestry_paper_packaging",
        "name": "Forestry/Paper/Packaging",
        "description": "Forestry, pulp, paper, fibre packaging, rigid/flexible packaging, and recycling-linked packaging companies.",
        "default_template_id": "forestry_paper_packaging",
        "template_candidates": ["forestry_paper_packaging", "consumer_staples", "industrials", "general_equity"],
        "aliases": ["forestry", "paper", "packaging", "timber", "pulp"],
        "detection_keywords": [
            "forestry",
            "timber",
            "timberland",
    ...
    },
    {
        ...
        "description": "Agribusiness, grain handlers, crop inputs, rural services, food commodities, and agricultural processors.",
        "default_template_id": "agriculture_agribusiness",
        "template_candidates": ["agriculture_agribusiness", "consumer_staples", "industrials", "general_equity"],
        "aliases": ["agriculture", "agribusiness", "grain", "rural_services", "crop_inputs"],
        "detection_keywords": [
            "agriculture",
            "agribusiness",
            "grain",
    ...
    },
    {
        ...
        "description": "Commercial aerospace OEMs, engines, suppliers, lessors, and aftermarket aviation businesses.",
        "default_template_id": "civil_aerospace",
        "template_candidates": ["civil_aerospace", "defence", "industrials", "general_equity"],
        "aliases": ["civil_aerospace", "commercial_aerospace", "aircraft", "airframe", "jet_engine"],
        "detection_keywords": [
            "civil aerospace",
    ...
    },
    {
        ...
        "description": "Crypto exchanges, miners, custody, infrastructure, treasury companies, and digital asset platforms.",
        "default_template_id": "crypto_digital_assets",
        "template_candidates": ["crypto_digital_assets", "technology_platforms", "general_equity"],
        "aliases": ["crypto", "digital_assets", "bitcoin", "blockchain", "crypto_miner"],
        "detection_keywords": [
            "crypto",
            "digital assets",
            "bitcoin",
    ...
    },
    {
        "id": "education",
        "name": "Education",
        "description": "Education providers, testing, student placement, publishing/courseware, tutoring, and workforce training companies.",
        "default_template_id": "education",
        "template_candidates": ["education", "consumer_staples", "technology_platforms", "general_equity"],
        "aliases": ["education", "edtech", "student_services", "testing", "training"],
        "detection_keywords": [
            "education",
            "university",
            "student",
    ...
    },
    {
        ...
        "description": "Traditional media, news, publishing, broadcasters, classifieds, and advertising-supported content businesses.",
        "default_template_id": "media_publishing",
        "template_candidates": ["media_publishing", "technology_platforms", "consumer_retail", "general_equity"],
        "aliases": ["media", "publishing", "broadcast", "newspaper", "classifieds"],
        "detection_keywords": [
            "media",
            "publishing",
            "newspaper",
...
PREALLOCATED_EXCHANGES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "retrieval_params": {
            ...
            "lookback_days_default": 365,
            "target_price_sensitive_default": 20,
            "target_non_price_sensitive_default": 5,
    ...
    },
    {
        ...
        "retrieval_params": {
            ...
            "target_price_sensitive_default": 15,
            "target_non_price_sensitive_default": 15,
            "price_sensitive_strategy": "lse_rns_deterministic_latest",
            "source_quality_priority": {
                "investegate.co.uk": 100,
                "londonstockexchange.com": 98,
                "lse.co.uk": 90,
            },
            "material_filing_tokens": [
                "interim results",
