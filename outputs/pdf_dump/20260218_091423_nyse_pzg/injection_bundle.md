...
- generated_at_utc: 2026-02-18T09:16:33.511427+00:00
...
- dropped_below_importance_threshold: 0

## Documents

1. `18_2025-05-12_sec_10_q_filing_2025_05_12.md` | ps=True | importance=90 | 2025-05-12 | SEC 10-Q filing (2025-05-12)
2. `01_2026-02-10_sec_10_q_filing_2026_02_10.md` | ps=True | importance=85 | 2026-02-10 | SEC 10-Q filing (2026-02-10)
3. `06_2025-11-20_sec_8_k_filing_2025_11_20.md` | ps=True | importance=85 | 2025-11-20 | SEC 8-K filing (2025-11-20)
4. `08_2025-11-14_sec_10_q_filing_2025_11_14.md` | ps=True | importance=85 | 2025-11-14 | SEC 10-Q filing (2025-11-14)
...
```json
{
  "generated_at_utc": "2026-02-18T09:16:33.511427+00:00",
  "worker_model": "openai/gpt-4o-mini",
  "dump_dir": "outputs/pdf_dump/20260218_091423_nyse_pzg",
  "injection_policy": {
    "min_importance_score": 80,
    "include_numeric_facts": false
  },
  ...
  "docs": [
    {
      ...
      "price_sensitive_confidence": 0.85,
      "price_sensitive_reason": "The document includes significant financial disclosures regarding the company’s operational losses, capital structure changes, and upcoming liquidity risks.",
      "importance_score": 90,
    ...
    },
    {
      ...
      "price_sensitive": true,
      "price_sensitive_confidence": 0.95,
      "price_sensitive_reason": "The document contains financial results, capital structure changes, and management's discussion that significantly impact the company's valuation.",
      "importance_score": 85,
    ...
    },
    {
      ...
      "price_sensitive": true,
      "price_sensitive_confidence": 0.9,
      "price_sensitive_reason": "The filing involves a significant equity raise that could impact stock price.",
      "importance_score": 85,
      "importance_tier": "high",
    ...
    },
    {
      ...
      "price_sensitive": true,
      "price_sensitive_confidence": 0.9,
      "price_sensitive_reason": "Contains critical financial data, funding changes and operational updates.",
      "importance_score": 85,
      "importance_tier": "high",
