...
- Template: consumer_retail
- Company name: [company_name].
- Company type: consumer_retail.
- Exchange: ASX.
...
- Run a dedicated sector lane (consumer/retail): capture 2-4 recent sources on consumer demand, pricing power/promotions, input-cost pressure, and wage/rent dynamics; tie each point to scenario assumptions.
...
Template focus:
* Template ID: consumer_retail
* Template Name: Consumer Retail
* Template Description: Investment analysis for consumer brands, retail, and discretionary businesses
* Analysis Type: consumer_retail
