...
- Run a dedicated sector lane (medtech): capture 2-4 recent sources on regulatory pathways (FDA/CE), reimbursement and coding, hospital/procedure demand, and device competition; tie each point to scenario assumptions.
...
Template focus:
* Template ID: medtech
* Template Name: Medtech
* Template Description: Investment analysis for medical device, diagnostics, and medtech platform companies
* Analysis Type: medtech
...
Score the company explicitly across these value factors and show the weighted contribution from each:
  ...
  * EV/Sales vs Growth
  * Gross Margin & Cash Conversion
  * Adoption Curve Optionality
  * Strategic Value
Value score rules:
