...
- Template: bauxite_miner
- Company name: [company_name].
- Company type: bauxite_miner.
- Exchange: ASX.
...
- Run a dedicated sector-macro lane (bauxite/alumina): capture 2-4 recent sources on alumina/aluminium pricing, refinery utilization, freight/energy costs, Chinese demand, and supply disruptions; tie each point to scenario assumptions.
...
Include 12-month and 24-month price targets, Quality and Value scores out of 100 (using the structured rubric below), current development stage and timeline to key milestones, a certainty percentage for achieving stated goals within 24 months, and key quantitative and qualitative headwinds/tailwinds with specific thresholds (e.g., bauxite/alumina price ranges impacting economics).
...
If data is missing (e.g., recovery, AISC), estimate based on industry standards for similar bauxite/alumina projects in the region (e.g., 85-90% recovery, A$2,000-3,000/tonne where applicable AISC) and justify assumptions.
...
* AISC (AU$/tonne where applicable): [Fill]
* Capex (AU$m): [Fill] (initial capex at Year 0)
* Discount Rate: 0.05
* Current Bauxite/Alumina Price (AU$/tonne where applicable): [Use spot price]
...
* Development: 0.6
* First Bauxite/Alumina Pour: 0.8
* Ramp-up: 0.9
* Peak Production: 1.0
...
* Management Quality (20%): Experience and track record in bauxite/alumina mining. Score based on Quantifiable Track Record, Insider Ownership, Capital Discipline.
    * Top-tier (proven multi-project success in region): 100
    * Experienced (solid bauxite/alumina experience): 90
...
* EV/Resource tonne where applicable (20%): Enterprise Value / Total JORC Resource tonne where applicable.
    * <A$50/tonne where applicable: 100
    * A$50-100/tonne where applicable: 70
    * A$100-150/tonne where applicable: 50
    * >A$150/tonne where applicable: 40
...
* Cost Competitiveness (15%): AISC percentile vs. global bauxite/alumina cost curve.
    * Bottom quartile (<A$1,500/tonne where applicable): 100
    * Second quartile (A$1,500-2,000/tonne where applicable): 80
    * Third quartile (A$2,000-2,500/tonne where applicable): 60
    * Top quartile (>A$2,500/tonne where applicable): 40
