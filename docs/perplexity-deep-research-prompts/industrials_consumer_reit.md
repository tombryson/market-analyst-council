# Industrials / Consumer / REIT

- Template ID: `industrials_consumer_reit`
- Category: `equity`
...
- Template: industrials_consumer_reit
- Company name: [company_name].
- Company type: industrials_consumer_reit.
- Exchange: ASX.
...
Template focus:
* Template ID: industrials_consumer_reit
* Template Name: Industrials / Consumer / REIT
* Template Description: Comprehensive investment analysis for industrial, consumer, and real-estate operating equities
* Analysis Type: industrials_consumer_reit
