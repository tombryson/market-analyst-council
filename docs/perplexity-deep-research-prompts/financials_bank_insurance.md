...
- Template ID: `financials_bank_insurance`
- Category: `financials`
...
- Template: financials_bank_insurance
- Company name: [company_name].
- Company type: financials_bank_insurance.
- Exchange: ASX.
...
Template focus:
* Template ID: financials_bank_insurance
* Template Name: Financials (Bank & Insurance)
* Template Description: Comprehensive investment analysis for banks, lenders, and insurance companies
* Analysis Type: financials
