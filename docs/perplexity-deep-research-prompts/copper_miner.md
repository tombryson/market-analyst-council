...
- Template: copper_miner
- Company name: [company_name].
- Company type: copper_miner.
- Exchange: ASX.
...
- Run a dedicated sector-macro lane (copper): capture 2-4 recent sources on LME/COMEX copper drivers (Chinese demand cycle, grid/electrification demand, inventories/treatment charges, supply disruptions) and tie each macro point to scenario assumptions.
...
Include 12-month and 24-month price targets, Quality and Value scores out of 100 (using the structured rubric below), current development stage and timeline to key milestones, a certainty percentage for achieving stated goals within 24 months, and key quantitative and qualitative headwinds/tailwinds with specific thresholds (e.g., copper price ranges impacting economics).
...
If data is missing (e.g., recovery, AISC), estimate based on industry standards for similar copper projects in the region (e.g., 85-90% recovery, A$2,000-3,000/lb where applicable AISC) and justify assumptions.
...
* AISC (AU$/lb where applicable): [Fill]
* Capex (AU$m): [Fill] (initial capex at Year 0)
* Discount Rate: 0.05
* Current Copper Price (AU$/lb where applicable): [Use spot price]
...
* Management Quality (20%): Experience and track record in copper mining. Score based on Quantifiable Track Record, Insider Ownership, Capital Discipline.
    * Top-tier (proven multi-project success in region): 100
    * Experienced (solid copper experience): 90
...
* EV/Resource lb where applicable (20%): Enterprise Value / Total JORC Resource lb where applicable.
    * <A$50/lb where applicable: 100
    * A$50-100/lb where applicable: 70
    * A$100-150/lb where applicable: 50
    * >A$150/lb where applicable: 40
...
* Cost Competitiveness (15%): AISC percentile vs. global copper cost curve.
    * Bottom quartile (<A$1,500/lb where applicable): 100
    * Second quartile (A$1,500-2,000/lb where applicable): 80
    * Third quartile (A$2,000-2,500/lb where applicable): 60
    * Top quartile (>A$2,500/lb where applicable): 40
