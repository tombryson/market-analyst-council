...
- Template: datacentres
- Company name: [company_name].
- Company type: datacentres.
- Exchange: ASX.
...
- Run a dedicated sector lane (datacentres): capture 2-4 recent sources on hyperscaler demand, power/grid constraints, lease-rate trajectory, capex financing costs, and supply pipeline by region; tie each point to scenario assumptions.
...
* Template Description: Investment analysis for data centre developers, operators, and digital infrastructure REITs
* Analysis Type: datacentres
...
Score the company explicitly across these quality factors and show the weighted contribution from each:
  * Power Access & Site Quality
  * Lease Quality & Customer Mix
  * Management
  * Delivery Execution
