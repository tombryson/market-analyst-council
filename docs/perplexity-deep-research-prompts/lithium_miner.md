...
- Template: lithium_miner
- Company name: [company_name].
- Company type: lithium_miner.
- Exchange: ASX.
...
- Run a dedicated sector-macro lane (lithium): capture 2-4 recent sources on spodumene/LCE pricing, Chinese conversion margins, EV and battery demand, inventory cycles, and supply curtailments; tie each macro point to scenario assumptions.
...
Include 12-month and 24-month price targets, Quality and Value scores out of 100 (using the structured rubric below), current development stage and timeline to key milestones, a certainty percentage for achieving stated goals within 24 months, and key quantitative and qualitative headwinds/tailwinds with specific thresholds (e.g., lithium price ranges impacting economics).
...
If data is missing (e.g., recovery, AISC), estimate based on industry standards for similar lithium projects in the region (e.g., 85-90% recovery, A$2,000-3,000/tonne/LCE where applicable AISC) and justify assumptions.
...
* AISC (AU$/tonne/LCE where applicable): [Fill]
* Capex (AU$m): [Fill] (initial capex at Year 0)
* Discount Rate: 0.05
* Current Lithium Price (AU$/tonne/LCE where applicable): [Use spot price]
...
* Management Quality (20%): Experience and track record in lithium mining. Score based on Quantifiable Track Record, Insider Ownership, Capital Discipline.
    * Top-tier (proven multi-project success in region): 100
    * Experienced (solid lithium experience): 90
...
* EV/Resource tonne/LCE where applicable (20%): Enterprise Value / Total JORC Resource tonne/LCE where applicable.
    * <A$50/tonne/LCE where applicable: 100
    * A$50-100/tonne/LCE where applicable: 70
    * A$100-150/tonne/LCE where applicable: 50
    * >A$150/tonne/LCE where applicable: 40
...
* Cost Competitiveness (15%): AISC percentile vs. global lithium cost curve.
    * Bottom quartile (<A$1,500/tonne/LCE where applicable): 100
    * Second quartile (A$1,500-2,000/tonne/LCE where applicable): 80
    * Third quartile (A$2,000-2,500/tonne/LCE where applicable): 60
    * Top quartile (>A$2,500/tonne/LCE where applicable): 40
