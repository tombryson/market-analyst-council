...
- Template: real_estate_reit
- Company name: [company_name].
- Company type: real_estate_reit.
- Exchange: ASX.
...
- Run a dedicated sector lane (REIT/real estate): capture 2-4 recent sources on cap-rate regime, leasing demand, vacancy/occupancy trends, financing costs, and transaction comps; tie each point to scenario assumptions.
...
Template focus:
* Template ID: real_estate_reit
* Template Name: Real Estate / REIT
* Template Description: Investment analysis for REITs and listed real-estate operating platforms
* Analysis Type: real_estate_reit
