...
- Template: pharma_biotech
- Company name: [company_name].
- Company type: pharma_biotech.
- Exchange: ASX.
...
- Run a dedicated sector lane (pharma/biotech): capture 2-4 recent sources on regulatory/pipeline backdrop (peer readout calendar, FDA/EMA policy signals, payer/reimbursement pressure, sector financing window) and tie each point to scenario assumptions.
...
Template rubric:
Run an investment analysis on [company_name] following this rubric. Include 12-month and 24-month price targets, Quality and Value scores out of 100, a summary of the current drug pipeline and timeline to key milestones, a certainty percentage for achieving stated goals within 24 months, and key quantitative and qualitative headwinds/tailwinds.
