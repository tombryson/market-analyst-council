...
- Run a dedicated sector lane (insurance): capture 2-4 recent sources on pricing cycle, claims inflation, catastrophe exposure, reserve trends, and investment income backdrop; tie each point to scenario assumptions.
...
* Template Description: Investment analysis for insurers and insurance brokers
