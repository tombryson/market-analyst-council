# Freshness Runner Agents Plan (2026-04-06)

## Why This Exists

The current "freshness" layer is too thin.
...
This should feel like a real monitoring system, not just "freshness age in days."
...
This is the real "freshness" brain.
...
- append a freshness decision log
...
- `/Users/Toms_Macbook/Projects/llm-council/backend/freshness_agents/inbox_sentinel.py`
- `/Users/Toms_Macbook/Projects/llm-council/backend/freshness_agents/source_resolver.py`
- `/Users/Toms_Macbook/Projects/llm-council/backend/freshness_agents/document_reader.py`
- `/Users/Toms_Macbook/Projects/llm-council/backend/freshness_agents/run_selector.py`
- `/Users/Toms_Macbook/Projects/llm-council/backend/freshness_agents/thesis_comparator.py`
- `/Users/Toms_Macbook/Projects/llm-council/backend/freshness_agents/action_judge.py`
- `/Users/Toms_Macbook/Projects/llm-council/backend/freshness_agents/lab_scribe.py`
- `/Users/Toms_Macbook/Projects/llm-council/backend/freshness_agents/models.py`
- `/Users/Toms_Macbook/Projects/llm-council/backend/freshness_agents/service.py`

Storage:
- `/Users/Toms_Macbook/Projects/llm-council/outputs/freshness_events/`
...
That gets us a real working "freshness runner" without pretending we already have a complete cross-exchange event engine.
...
- `freshness_agents/models.py`
- `freshness_agents/service.py`
- `freshness_agents/action_judge.py`

Then wire a single entrypoint like:

```python
async def process_announcement_event(event: AnnouncementEvent) -> FreshnessDecision:
    ...
```
